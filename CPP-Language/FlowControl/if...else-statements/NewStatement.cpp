...
string q[] = {"I swear ", "Well, ","Urgh ","Uhmm ","Ehh ","Hmm ","Yeah ","Hey "};
...
void generate() {
    ...
    cout <<q[rand()%(sizeof(q)/sizeof(q[0]))] + excuses[rand()%(sizeof(excuses)/sizeof(excuses[0]))] <<"." << endl;
}
